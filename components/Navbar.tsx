...
export default function Navbar() {
	...
	return (
		<nav
            ...
            before:content-[''] before:absolute before:w-[calc(100%_+_2rem)] md:before:w-[calc(100%_+_8rem)] before:h-[calc(100%_+_2rem)] 
			before:-mt-8 before:-ml-4 md:before:-ml-16
